"""
Django settings for bagas31 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-763io86x)&vcapk8*6-+&$33x8d*$x7g(cwk*8h6y3)k86qvwp')
...
WSGI_APPLICATION = 'bagas31.wsgi.application'
